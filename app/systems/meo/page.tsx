      ...
      <section className="py-16 max-w-5xl mx-auto px-6">
        ...
        <div className="space-y-6 max-w-2xl mx-auto">
          {[
            ...
            {q:"MEO対策業者から乗り換えできますか？",a:"はい。月額3〜5万円のMEO業者から乗り換えるケースが多いです。乗り換え時は現在の順位状況・対策キーワードをヒアリングし、初期設定（追跡キーワード・院情報・テンプレート）まで無料でセットアップします。乗り換え後は「何をやっているかが全部見える状態」になります。"},
            {q:"整体院以外でも使えますか？",a:"はい。鍼灸院・接骨院・サロンでもご利用いただけます。業種に合わせた投稿文・SEO記事を自動生成します。"},
            {q:"順位は本当に上がりますか？",a:"順位はGoogleのアルゴリズムに依存するため、絶対保証はできません。ただし「投稿頻度・キーワード対策・口コミ返信」がMEOの主要評価軸であり、本ツールはこの3点を仕組みで継続できる状態にします。多くの院で1〜3ヶ月で順位改善が見られています。"},
            {q:"WordPressが無いと使えませんか？",a:"WordPress連携機能は任意です。WordPressをお使いの方は記事をワンクリック公開できますが、お使いでない方も「生成したコンテンツをコピーしてGBP/note/SNSに貼る」運用で使えます。"},
            {q:"追跡キーワードは変更できますか？何個まで登録できますか？",a:"いつでも追加・変更可能です。1院あたり10〜20キーワードの登録を推奨しています。「症状×地域」「治療法×地域」など、患者が実際に検索するキーワードをこちらで一緒に選定します。"},
          ].map(({q,a})=>(
