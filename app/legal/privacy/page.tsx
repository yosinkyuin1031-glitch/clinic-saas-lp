    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-sm leading-7 text-gray-800">
          ...
          <section>
            <p>
              株式会社IDOMI（以下「当社」といいます）は、「ClinicApps」（以下「本サービス」といいます）の提供にあたり、お客様の個人情報の保護を重要な責務と認識し、個人情報の保護に関する法律（個人情報保護法）その他関連法令を遵守いたします。本プライバシーポリシーは、当社における個人情報の取り扱いについて定めるものです。
            </p>
          </section>
...
〒558-0004 大阪府大阪市住吉区長居東4-2-7 長居中央ビル304
          ...
          <section>
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-1 text-sm">
              <p>
                <span className="font-medium">事業者名：</span>株式会社IDOMI
              </p>
              <p>
